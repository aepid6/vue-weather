<template>
    <section class="not-found-page">
        ...
        <p class="not-found-copy">요청하신 페이지는 현재 관측 범위에 없습니다.<br>날씨 지도로 돌아가 새로운 경로를 찾아보세요.</p>
        <RouterLink class="not-found-link" to="/"><span aria-hidden="true">←</span> 날씨 지도 돌아가기</RouterLink>
    </section>
</template>
